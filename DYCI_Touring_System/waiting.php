...
<head>
    <meta charset="UTF-8">
    <title>Waiting Area - DYCI Tour</title>
    <style>
        body {
            margin: 0;
            padding: 0;
    ...
    <div class="overlay">
        ...
        <div class="content">
            <div class="location-title">
                ...
                <div class="location-name">Waiting Area Located in The Entrance after the Guard Outpost</div>
            </div>
            <img src="images/waiting.jpg" alt="Waiting Area" class="location-image">
        </div>
